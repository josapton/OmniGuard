  ...
  const handlePostAuth = async (session: any) => {
    ...
    if (profile) {
      ...
      if (error) {
        ...
        toast({ title: "Welcome to OmniGuard!", description: "Your account has been created." });
        navigate("/", { replace: true });
      }
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      ...
      >
        <div className="flex flex-col items-center gap-4 mb-6">
          <img src={omniguardLogo} alt="OmniGuard" className="h-14 w-14 rounded-full" />
          ...
          <CardContent className="p-6 space-y-5">
            ...
            <div className="space-y-3">
              <p className="text-xs text-muted-foreground text-center">
                {mode === "signin"
                  ? "Sign in to your existing OmniGuard account"
                  : "Create a new OmniGuard account to get started"}
              </p>
