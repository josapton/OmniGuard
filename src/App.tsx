...
const AppRoutes = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/modeling" element={<ProtectedRoute><AppLayout><PageTransition><ThreatModeling /></PageTransition></AppLayout></ProtectedRoute>} />
      <Route path="/exposure" element={<ProtectedRoute><AppLayout><PageTransition><ExposureManagement /></PageTransition></AppLayout></ProtectedRoute>} />
      <Route path="/remediation" element={<ProtectedRoute><AppLayout><PageTransition><AutoRemediation /></PageTransition></AppLayout></ProtectedRoute>} />
      <Route path="/osint" element={<ProtectedRoute><AppLayout><PageTransition><OsintAnalysis /></PageTransition></AppLayout></ProtectedRoute>} />
